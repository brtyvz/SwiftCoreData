...
class ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewWillAppear(_ animated: Bool) {
        NotificationCenter.default.addObserver(self, selector: #selector(tumVerileriAl), name: NSNotification.Name("veriGirildi"), object: nil)
    }
    
   @objc func tumVerileriAl(){
    ...
    idDizisi.removeAll(keepingCapacity: false)
        ...
        do {
            ...
            if sonuclar.count>0{  for sonuc in  sonuclar as! [NSManagedObject]{
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "toDetailsVC"{
            ...
            destinationVC?.secilenUUID = secilenUUID
